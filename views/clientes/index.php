                    ...
                    <div class="row mb-3">
                        <div class="col-md-4 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input class="form-control" type="text" name="num_identidad" id="num_identidad" placeholder="N° Identidad">
                            </div>
...
<script>
    document.getElementById("telefono").addEventListener("input", function() {
        let inputElement = this;
        let inputValue = inputElement.value.replace(/\D/g, ''); // Remover characters
        let formattedValue = '';
        ...
        // Limite de entrada es de 8 digitos
