    ...
    <div class="wrapper">
        ...
        <div class="sidebar-wrapper" data-simplebar="true">
            <div class="sidebar-header">
                ...
                <div>
                    <h4 class="logo-text">Comercial</h4>
                </div>
            ...
            <ul class="metismenu" id="menu">
                ...
                <?php if (verificar('usuarios')  || verificar('roles')) { ?>
                <li>
                ...
                <?php } if ( verificar('categorias') || verificar('productos')) { ?>
                    <li>
                        <a href="javascript:;" class="has-arrow">
                ...
                if (verificar('inventario')) { ?>
                   ...
                   <!--PROGRAMAR RESPALDO -->
                    <li>
                    <a href="<?php echo BASE_URL . 'Respaldo'; ?>">
                        <div class="parent-icon"><i class="fas fa-undo"></i>
                        </div>
                        <div class="menu-title">Respaldo/Restaurar</div>
                    </a>
                </li>
                <!--PROGRAMAR ACERCA DE-->
                <li>
                    <a href="<?php echo BASE_URL . 'Acerca de'; ?>">
                        <div class="parent-icon"><i class="fas fa-wrench"></i>
                        </div>
