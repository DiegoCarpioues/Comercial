...
class ApartadosModel extends Query{
    ...
    {
        $sql = "SELECT ap.*, cl.num_identidad, cl.nombre, cl.telefono, cl.direccion FROM apartados ap INNER JOIN clientes cl ON ap.id_cliente = cl.id WHERE ap.id = $idApartado";
        return $this->select($sql);
    }
