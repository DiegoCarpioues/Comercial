...
class ClientesModel extends Query{
    ...
    public function registrar($num_identidad, $nombre,
    $telefono, $correo, $direccion)
    {
        $sql = "INSERT INTO clientes (num_identidad, nombre, telefono, correo, direccion) VALUES (?,?,?,?,?)";
        $array = array($num_identidad, $nombre,
        $telefono, $correo, $direccion);
    ...
    public function actualizar($num_identidad, $nombre,
    $telefono, $correo, $direccion, $id)
    {
        $sql = "UPDATE clientes SET  num_identidad=?, nombre=?, telefono=?, correo=?, direccion=? WHERE id=?";
        $array = array($num_identidad, $nombre,
        $telefono, $correo, $direccion, $id);
        return $this->save($sql, $array);
    }
